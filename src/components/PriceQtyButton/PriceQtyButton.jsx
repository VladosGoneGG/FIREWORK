...
const PriceQtyButton = ({
	...
	const textColorClass = readOnly ? 'text-stone-600' : 'text-white'
	...
	return (
		...
		>
			...
			>
				{/* Минус — скрыта в readOnly (нет в наличии — товар нельзя добавить) */}
				{!readOnly && (
					<motion.button
						type='button'
				...
				<div className='flex flex-col items-center leading-none font-baron cursor-default select-none font-normal'>
					<div className='flex items-baseline pb-[5px] gap-1'>
						<span
							className={[
								'text-[20px] leading-none font-normal',
								textColorClass,
							].join(' ')}
						>
						...
						<span
							className={[
								'text-[12px] leading-none relative top-[2px] lowercase font-normal',
								textColorClass,
							].join(' ')}
						>
							руб.
