...
const ContactsPage = () => {
	return (
		<div
			className='
				bg-white min-h-[100dvh]
				flex flex-row justify-center items-center
				max-[1040px]:flex max-[1040px]:flex-col
				max-[1040px]:items-stretch
				max-[1040px]:text-left
			'
		>
			...
			<div
				className='
					...
					max-[1040px]:w-full
					max-[1040px]:min-h-[calc(100dvh-56px)]
					max-[1040px]:h-auto
					max-[1040px]:flex-1
					max-[1040px]:justify-start
					max-[1040px]:items-stretch
					max-[1040px]:p-[30px]
					max-[1040px]:gap-4
					max-[1040px]:text-left
			...
			>
				...
				<div
					className='
						flex gap-[60px] justify-center items-center font-baron
						max-[1040px]:flex-col
						max-[1040px]:justify-start
						max-[1040px]:items-start
						max-[1040px]:w-full
						max-[1040px]:px-0
						max-[1040px]:max-w-none
					'
				>
